...
<body
    class="antialiased min-h-screen bg-dots-darker bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900 transition-colors duration-200">
    <x-navbar />
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="text-center mb-12">
                <div class="relative inline-block">
                    ...
                    <div
                        class="absolute bottom-4 right-0 bg-green-500 w-4 h-4 rounded-full border-2 border-white dark:border-gray-900 transition-colors duration-200">
                    </div>
                </div>
                ...
                <p class="mt-2 text-lg text-gray-600 dark:text-gray-400 transition-colors duration-200">Full Stack
                    Developer</p>
            </div>
                    ...
                    <div class="space-y-4">
                        ...
                        <div>
                            <div class="flex justify-between mb-1">
                                <span
                                    class="text-sm font-medium text-gray-700 dark:text-gray-300">{{$skill['name']}}</span>
                                <span
                                    class="text-sm font-medium text-gray-700 dark:text-gray-300">{{$skill['percentage']}}</span>
                            </div>
                            <div class="w-full bg-gray-200 rounded-full h-2 dark:bg-gray-700">
                                <div class="bg-red-600 h-2 rounded-full" style="width:{{ $skill['percentage'] }}%">
                                </div>
                            </div>
                        </div>
                        @endforeach
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex items-center space-x-4">
                            <div class="flex-shrink-0">
                                <div
                                    class="w-12 h-12 flex items-center justify-center bg-{{ $project['icon'] }}-100 dark:bg-{{ $project['icon'] }}-900/30 rounded-xl">
                                    <span
                                        class="text-{{ $project['icon'] }}-600 dark:text-{{ $project['icon'] }}-400 font-bold text-lg">
                                        {{ strtoupper(substr($project['title'], 0, 1)) }}
                                    </span>
                                </div>
                            </div>
                            <div>
                                <h3 class="text-lg font-medium text-gray-900 dark:text-white">{{ $project['title'] }}
                                </h3>
