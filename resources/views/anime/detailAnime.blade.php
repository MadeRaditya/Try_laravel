...
<head>
    ...
    <title>{{ $data['title'] }} - Anime Detail</title>
                        ...
                        <div class="flex flex-col lg:flex-row gap-8">
                            ...
                            <div class="lg:w-1/3">
                                <div class="relative group">
                                    ...
                                    <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300"></div>
                                </div>
                                ...
                                <div class="mt-6 space-y-4">
                                    <div class="flex items-center justify-between p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                        ...
                                        <div class="flex items-center">
                                            ...
                                            <span class="ml-1 font-semibold text-gray-900 dark:text-white">{{ $data['score'] }} / 10</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="font-semibold text-gray-900 dark:text-white">#{{ $data['rank'] }}</span>
                                        </div>
                                    </div>
                                    ...
                                    <div class="p-3 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                                        <div class="flex justify-between items-center">
                                            ...
                                            <span class="font-semibold text-gray-900 dark:text-white">#{{ $data['popularity'] }}</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
