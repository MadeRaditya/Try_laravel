...
<body class=" flex flex-col min-h-screen antialiased min-h-screen bg-dots-darker bg-gray-100 dark:bg-dots-lighter dark:bg-gray-900">
    <x-navbar/>
        ...
        <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="bg-white dark:bg-gray-800 shadow-xl rounded-2xl overflow-hidden">
                <div class="p-6">
                    <!-- Alert Messages -->
                    @if(session('success'))
                        <div class="mb-4 p-4 bg-green-50 dark:bg-green-900/30 rounded-xl border border-green-200 dark:border-green-800">
                            <div class="flex">
                    ...
                    <div class="space-y-3">
                        @foreach ($data as $item)
                            <div class="group flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-xl hover:shadow-md transition-all duration-200">
                                <div class="flex items-center gap-4">
                                    ...
                                    <span class="{{ $item->is_done == '1' ? 'line-through text-gray-400 dark:text-gray-500' : 'text-gray-900 dark:text-white' }}">
                                        {{ $item->task }}
                                    </span>
                                </div>
                        ...
                        <ul class="list-group mb-4" id="todo-list">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">
                                ...
                                <input type="text" class="form-control edit-input" style="display: none;"
                                    value="{{$item->task}}">
                                <div class="btn-group">
                                <form action="{{route('todo.delete',["id"=>$item->id])}}" method="POST" onsubmit="return confirm('Yakin Menghapus task ini ?')">
                                @csrf
                                @method('delete')
